...
def inputs(i:int, direct:bool=False):
    ...
    fundamental={"fundamental_conversion_score":78,"fundamental_coverage_pct":90,"fundamental_data_quality_score":90,"fundamental_official_source_coverage_pct":85,"fundamental_cashflow_state":"IDX_OFFICIAL_YTD_OCF_FCF_AVAILABLE","fundamental_cashflow_quality_state":"CASHFLOW_POSITIVE_CONVERTING","operating_cash_flow_latest":220,"free_cash_flow_proxy_latest":170,"ocf_conversion_ratio":1.2,"fundamental_growth_consistency_state":"QUARTER_AND_YTD_CONFIRMED","fundamental_period_freshness_state":"CURRENT_QUARTERLY_PERIOD","fundamental_leverage_risk_state":"BALANCE_SHEET_CAPACITY_OK","fundamental_state":"FUTURE_FUNDAMENTAL_SUPPORTIVE"}
