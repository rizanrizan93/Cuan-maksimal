...
"""Fail-closed, scoring-independent evidence coverage measurement for Emir."""
...
ENGINE_VERSION = "1.0.0-emir-independent-evidence-coverage"
...
def build_evidence_coverage(
    ...
    *,
    ...
    summary: dict[str, Any] = {"engine_version": ENGINE_VERSION, "scanner": "EMIR", "total_universe": total, "as_of": as_of_day.date().isoformat(), "latest_expected_idx_session": latest_expected.date().isoformat()}
