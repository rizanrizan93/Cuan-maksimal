...
def evaluate_pullback_setup(d: pd.DataFrame, fresh_bars: int = 3, max_age_bars: int = 18) -> dict:
    ...
    momentum_ok = bool((np.isfinite(rsi14) and rsi14 >= 45) or (np.isfinite(adx14) and adx14 >= 12))

    valid = bool(trend_up and mitigation_ok and reclaim_ok and structure_ok and momentum_ok)
