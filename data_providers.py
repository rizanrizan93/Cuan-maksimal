...
USER_AGENT = "Mozilla/5.0 (compatible; IDX-Emir-Public-Framework-Scanner/1.3; research)"
...
def fetch_ohlcv(ticker: str, period: str = "5y", *, completed_only: bool = True, now: Any = None, direct_retries: int = 3) -> FetchResult:
    ...
    try:
        downloaded = yf.download(symbol, period=period, interval="1d", auto_adjust=True, progress=False, threads=False, group_by="column")
...
__all__ = [
    "FetchResult", "bare_ticker", "completed_session_frame", "fetch_many_news", "fetch_many_ohlcv",
    "normalize_ticker", "parse_universe_csv", "parse_universe_frame", "_sanitize_ohlcv",
]
