...
SOURCE = ROOT / "validation_artifacts_v1_6_3" / "TWENTY_TICKER_RADAR_SOURCE_V1_6_3.csv"
OUT = ROOT / "validation_artifacts_v1_6_3"
...
(OUT / "TOP3_DASHBOARD_PREVIEW_V1_6_3.html").write_text(preview, encoding="utf-8")
top3.to_csv(OUT / "TOP3_DASHBOARD_SAMPLE_V1_6_3.csv", index=False)
...
(OUT / "TOP3_DASHBOARD_VALIDATION_V1_6_3.json").write_text(json.dumps(summary, indent=2), encoding="utf-8")
