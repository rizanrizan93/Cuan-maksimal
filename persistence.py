...
DATABASE_SCHEMA_VERSION = "emir_autonomous_schema_v7"
SCANNER_VERSION = "1.6.3-progressive-deep-review-db-transfer-dashboard"
...
def test_connection(config: DatabaseConfig) -> pd.DataFrame:
    ...
    rows.insert(
        ...
        {
            **base,
            "state": "HEALTHY_EMIR_DATABASE_V7" if healthy else "DATABASE_NOT_READY_V7",
            "table": "__SUMMARY__",
