...
def _base(fundamental):
    features={"feature_state":"OK","smart_money_score":80,"smart_money_coverage_pct":100,"market_structure_score":80,"market_structure_mode":"CONTINUATION_SETUP","trend_score":82,"liquidity_score":75,"distribution_score":10,"crowding_score":30,"execution_friction_score":10,"price_stage":"BASE_TRANSITION","absorption_score":80,"last_price":1000,"ema20":970,"high20":1020,"low20":930,"atr14":30,"previous_high20":1140,"prior_high20":1160,"prior_high55":1240,"prior_high120":1320,"prior_high252":1450,"adtv20_idr":1_000_000_000,"gap_risk_score":0,"ohlcv_integrity_state":"VALID","corporate_action_anomaly_flag":False}
...
def test_cashflow_availability_label_without_values_never_authorizes_capital():
    fundamental={"fundamental_conversion_score":78,"fundamental_coverage_pct":90,"fundamental_data_quality_score":90,"fundamental_official_source_coverage_pct":85,"fundamental_observed_at":"2026-08-08T09:00:00Z","fundamental_availability_state":"POINT_IN_TIME_OBSERVED","fundamental_cashflow_state":"IDX_OFFICIAL_YTD_OCF_FCF_AVAILABLE","fundamental_period_freshness_state":"CURRENT_QUARTERLY_PERIOD","fundamental_growth_consistency_state":"QUARTER_AND_YTD_CONFIRMED","fundamental_leverage_risk_state":"BALANCE_SHEET_CAPACITY_OK","fundamental_state":"FUTURE_FUNDAMENTAL_SUPPORTIVE"}
    row=_base(fundamental)
    assert row["real_money_ready"] is False
