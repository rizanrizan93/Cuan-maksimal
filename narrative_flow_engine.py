...
ENGINE_VERSION = "1.9.0-real-money-official-xbrl"
...
def build_emir_profile(
    *, ticker: str, features: Mapping[str, Any], narrative: Mapping[str, Any] | None = None,
    ...
    if official_cov < 50: blockers.append("OFFICIAL_FUNDAMENTAL_COVERAGE_LT_50")
    if data_quality < 75: blockers.append("FUNDAMENTAL_DATA_QUALITY_LT_75")
    if "MISSING" in cashflow_state or not cashflow_state: blockers.append("CASHFLOW_EVIDENCE_MISSING")
    ...
    real_money_ready = bool(real_money_candidate and integrity_ready and orderbook_verified and precise_ready)
