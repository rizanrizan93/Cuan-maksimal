...
ENGINE_VERSION = "1.9.11-lineage-sector-integrity"
...
def build_emir_profile(
    *, ticker: str, features: Mapping[str, Any], narrative: Mapping[str, Any] | None = None,
    ...
    real_money_entry_candidate = bool(real_money_candidate and state in actionable_real_money_states)
    ...
    real_money_ready = bool(real_money_entry_candidate and direct_fundamental_ready and direct_story_ready and integrity_ready and orderbook_verified and precise_ready)
    ...
    return {
        ...
        **dict(features), **market, **sector, **narrative, **broker, **ownership, **orderbook, **integrity, **fundamental, **calibration,
        ...
        "production_tier": ("GUARDED_DIRECT_VERIFIED" if real_money_ready else "MANUAL_CONFIRMATION_REQUIRED" if real_money_entry_candidate else "WAIT_TIMING" if real_money_candidate else "NOT_READY") if guarded_real_money else ("DIRECT_PRECISE" if precise_ready else "AUTO_EOD_PROXY" if auto_eod_ready else "NOT_READY"),
