...
ENGINE_VERSION = "1.4.0-autonomous-public-data-and-eod-proxy"
...
def build_emir_profile(
    *, ticker: str, features: Mapping[str, Any], narrative: Mapping[str, Any] | None = None,
    ...
    integrity_auto_public = integrity_provenance in {"AUTO_PUBLIC_KSEI_PROXY", "AUTO_PUBLIC_KSEI_AND_REGULATORY_NEWS"}
    ...
    integrity_auto_ready = bool(integrity_auto_public and integrity_coverage >= 50 and not integrity_hard_block)
